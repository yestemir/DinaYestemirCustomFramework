#
# Be sure to run `pod lib lint DinaYestemirCustomFramework.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :git => 'https://github.com/yestemir/DinaYestemirCustomFramework.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '9.0'
  s.swift_version = ['5.0', '5.1', '5.2']
  s.source_files = 'Sources/DinaYestemirCustomFramework/Classes/**/*'
